...
/* #undef LWS_MINGW_SUPPORT *////non
#define LWS_NO_CLIENT
#define LWS_NO_DAEMONIZE
/* #undef LWS_OPENSSL_CLIENT_CERTS *////non
#define LWS_OPENSSL_SUPPORT
/* #undef LWS_PLAT_OPTEE *////non
//#define LWS_PLAT_FREERTOS///non
#if !defined(WIN32) && !defined(_WIN32)
#define LWS_PLAT_UNIX
#endif
//#define LWS_ROLE_CGI///non
//#define LWS_ROLE_DBUS///non
#define LWS_ROLE_H1
#define LWS_ROLE_H2
#define LWS_ROLE_RAW
...
/* #undef LWS_SHA1_USE_OPENSSL_NAME *////non
/* #undef LWS_SSL_CLIENT_USE_OS_CA_CERTS *////non
...
/* #undef LWS_WITH_BORINGSSL *////non
//#define LWS_WITH_CGI///non
#define LWS_WITH_CUSTOM_HEADERS
/* #undef LWS_WITH_DEPRECATED_LWS_DLL *////non
#define LWS_WITH_DETAILED_LATENCY
#define LWS_WITH_DIR
#define LWS_WITH_DRIVERS
//#define LWS_WITH_ESP32///non
/* #undef LWS_HAVE_EVBACKEND_LINUXAIO *////non
/* #undef LWS_HAVE_EVBACKEND_IOURING *////non
/* #undef LWS_WITH_EXTERNAL_POLL *////non
#define LWS_WITH_FILE_OPS
//#define LWS_WITH_FSMOUNT ///non
#define LWS_WITH_FTS 
#define LWS_WITH_GENCRYPTO
#define LWS_WITH_GENERIC_SESSIONS
/* #undef LWS_WITH_GLIB */ ///non
/* #undef LWS_WITH_GTK */ ///non
#define LWS_WITH_HTTP2
#define LWS_WITH_HTTP_BASIC_AUTH
//#define LWS_WITH_HTTP_BROTLI ///non
...
/* #undef LWS_WITH_LIBEV */ ///non
/* #undef LWS_WITH_LIBEVENT */ ///non
...
/* #undef LWS_WITH_PLUGINS *////non
/* #undef LWS_WITH_POLARSSL *////non
...
/* #undef LWS_WITH_STRUCT_SQLITE3 *////non
#define LWS_WITH_STRUCT_JSON
/* #undef LWS_WITH_SQLITE3 *////non
/* #undef LWS_WITH_SYS_NTPCLIENT *////non
/* #undef LWS_WITH_SYS_DHCP_CLIENT *////non
...
/* #undef USE_OLD_CYASSL *////non
/* #undef USE_WOLFSSL *////non
#define LWS_WITH_EVENT_LIBS
/* #undef LWS_WITH_EVLIB_PLUGINS *////non
#define LWS_WITH_LIBUV_INTERNAL
/* #undef LWS_WITH_PLUGINS_API *////non
