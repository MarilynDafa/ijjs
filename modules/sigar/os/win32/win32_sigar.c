    ...
    sigar_sys_info_t* sysinfo)
{
    ...
    */
    ...
    {
        vendor_name = "Windows Server 2016";
        vendor_version = "2016";
        code_name = "Windows Server 2016";
    }
    else if (IsWindows8Point1OrGreater())
    {
        vendor_name = "Windows Server 2012 R2";
        vendor_version = "2012";
        code_name = "Windows Server 2012 R2";
    }
    else if (IsWindows8OrGreater())
    {
        vendor_name = "Windows Server 2012";
        vendor_version = "2012";
        code_name = "Windows Server 2012";
    }
    else if (IsWindows7OrGreater())
    {
        vendor_name = "Windows Server 2008";
        vendor_version = "2008";
        code_name = "Windows Server 2008";
    }
    else
    {
        vendor_name = "Windows Server 2003";
        vendor_version = "2003";
        code_name = "Windows Server 2003";
    }
