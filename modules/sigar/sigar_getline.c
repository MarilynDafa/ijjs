...
#if defined(MSDOS) && !defined(MINGWRUNTIME)
...
#if defined(unix) || defined(MSDOS) || defined(MINGWRUNTIME) || defined(R__MWERKS)
...
#if defined(unix) || defined(MINGWRUNTIME) || defined(R__MWERKS)
